`ifndef APB_MULTI_SLAVE_MIN_MAX_MID_ADDR_TEST
`define APB_MULTI_SLAVE_MIN_MAX_MID_ADDR_TEST

class apb_multi_slave_min_max_mid_addr_test extends apb_base_test;

    `uvm_component_utils(apb_multi_slave_min_max_mid_addr_test)

    apb_multi_slave_min_max_mid_addr_seqs s2_seq;

    function new(string name = "apb_low_order_addr_test", uvm_component parent = null);
    ...
    function void build_phase (uvm_phase phase);
        ...
        s2_seq = apb_multi_slave_min_max_mid_addr_seqs :: type_id :: create("s2_seq");
    endfunction
    ...
    task run_phase(uvm_phase phase);
        ...
        fork
            ...
            begin
                ...
                s2_seq.start(env_h.agent_hm.seqr_hm);
