`ifndef APB_MULTI_SLAVE_PWDATA_CORNER_RW_TEST
`define APB_MULTI_SLAVE_PWDATA_CORNER_RW_TEST

class apb_multi_slave_pwdata_corner_rw_test extends apb_base_test;

    `uvm_component_utils(apb_multi_slave_pwdata_corner_rw_test)

    apb_multi_slave_pwdata_corner_rw_seqs multi_slv_seq;

    function new(string name = "apb_multi_slave_pwdata_corner_rw_test", uvm_component parent = null);
        super.new(name, parent);
        config_ht.no_of_slaves = $urandom_range(2,4);
    endfunction

    function void build_phase (uvm_phase phase);
        super.build_phase(phase);
        multi_slv_seq = apb_multi_slave_pwdata_corner_rw_seqs :: type_id :: create("multi_slv_seq");
    endfunction
    ...
    task run_phase(uvm_phase phase);
        ...
        fork
            ...
            begin
                ...
                multi_slv_seq.start(env_h.agent_hm.seqr_hm);
