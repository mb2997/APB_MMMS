`ifndef APB_MULTI_SLAVE_B2B_RW_TEST
`define APB_MULTI_SLAVE_B2B_RW_TEST

class apb_multi_slave_b2b_rw_test extends apb_base_test;

    `uvm_component_utils(apb_multi_slave_b2b_rw_test)

    apb_multi_slave_b2b_rw_seqs multi_slv_b2b_seq;

    function new(string name = "apb_multi_slave_b2b_rw_test", uvm_component parent = null);
    ...
    function void build_phase (uvm_phase phase);
        ...
        multi_slv_b2b_seq = apb_multi_slave_b2b_rw_seqs :: type_id :: create("multi_slv_b2b_seq");
    endfunction
    ...
    task run_phase(uvm_phase phase);
        ...
        fork
            ...
            begin
                ...
                multi_slv_b2b_seq.start(env_h.agent_hm.seqr_hm);
