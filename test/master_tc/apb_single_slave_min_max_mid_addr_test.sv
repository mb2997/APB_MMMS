`ifndef APB_1SLAVE_MIN_MAX_MID_ADDR_TEST
`define APB_1SLAVE_MIN_MAX_MID_ADDR_TEST

class apb_single_slave_min_max_mid_addr_test extends apb_base_test;

    `uvm_component_utils(apb_single_slave_min_max_mid_addr_test)

    apb_single_slave_min_max_mid_addr_seqs s1_seq;

    function new(string name = "apb_single_slave_min_max_mid_addr_test", uvm_component parent = null);
    ...
    function void build_phase (uvm_phase phase);
        ...
        s1_seq = apb_single_slave_min_max_mid_addr_seqs :: type_id :: create("s1_seq");
    endfunction
    ...
    task run_phase(uvm_phase phase);
        ...
        fork
            ...
            begin
                ...
                s1_seq.start(env_h.agent_hm.seqr_hm);
