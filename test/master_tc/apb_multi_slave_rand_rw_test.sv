`ifndef APB_MULTI_SLAVE_RAND_RW_TEST
`define APB_MULTI_SLAVE_RAND_RW_TEST

class apb_multi_slave_rand_rw_test extends apb_base_test;

    `uvm_component_utils(apb_multi_slave_rand_rw_test)

    apb_multi_slave_rand_rw_seqs multi_slv_seq;

    function new(string name = "apb_multi_slave_rand_rw_test", uvm_component parent = null);
    ...
    function void build_phase (uvm_phase phase);
        ...
        multi_slv_seq = apb_multi_slave_rand_rw_seqs :: type_id :: create("multi_slv_seq");
    endfunction
